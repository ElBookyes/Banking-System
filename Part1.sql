...
VALUES (1, 'Отдел A', 'Отдел B', TO_DATE('2024-01-01', 'YYYY-MM-DD'));

INSERT INTO EMPLOYEE_MOVEMENT (EMPLOYEE_ID, DEPARTMENT_FROM, DEPARTMENT_TO, MOVEMENT_DATE)
VALUES (2, 'Отдел C', 'Отдел D', TO_DATE('2024-02-15', 'YYYY-MM-DD'));

INSERT INTO EMPLOYEE_MOVEMENT (EMPLOYEE_ID, DEPARTMENT_FROM, DEPARTMENT_TO, MOVEMENT_DATE)
VALUES (3, 'Отдел B', 'Отдел C', TO_DATE('2024-03-10', 'YYYY-MM-DD'));
...
-- 1 Да се реализира листинг показващ всички служители които са били уволнени от компанията
...
FROM EMPLOYEE
WHERE STATUS = 'fired';
-- 2 Да се реализира листинг на всички служители които са в майчинство в момента.
SELECT *
FROM EMPLOYEE
...
-- 5 Намерете всички старши служители които получават заплата по висока от 5000 лв. 
...
-- 8 Намерете средната заплата във всеки отдел, групирайте по отдел и
--изкарайте средната заплата
